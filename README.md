...
## Future Directions:
These models can continued to be improved. After grid searching every model exhibited over fitting of the training data. One way to address this would be to try a different modeling method for example a mutli-nomial neural network.  
